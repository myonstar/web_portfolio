        ...
        <div>
            <div>
                ...
                <div className="p-5">
                    ...
                    {/* 주요 개발사항 */}
                    <div>
                        <p className="text-2xl mt-3 my-2">◎ 주요 개발사항</p>
                    ...
                    <div>
                        ...
                        <p className="text-2xl ml-6 my-1 inline">- React</p>
                        <p className="text-2xl ml-6 my-1 inline">- Next.js</p>
                    ...
                    <div>
                        ...
                        <p className="text-xl ml-6 my-1 inline">▶ 참고 영상을 참조하며 웹 포트폴리오를 만들면서 캡슐화된 컴포넌트 단위로 개발 후
                    ...
                    {/* 부록 : 참고 영상 */}
                    <div>
                        <p className="text-2xl mt-3 my-1">◎ 참고 영상</p>
                ...
                <div className="p-5 flex">
                    ...
                    <div className="m-3">
                        <Image
                            ...
                            height={480}
                            quality={100} />
                        <p className="text-base my-3">React 라이브러리의 프레임워크인 Next.js를 사용함으로써 SSR(서버 사이드 렌더링)을 지원하는 Next.js의 장점을 깨달았으며
                            생소했던 React의 대략적인 사용법도 배울 수 있었습니다.
                        </p>
                    </div>
                    {/* Vercel 설명 */}
                    <div className="m-3">
                        <Image
                            ...
                            height={480}
                            quality={100} />
                        <p className="text-base my-3">Next.js를 개발한 Vercel이 제공하는 서비스를 사용하면 연동된 GitHub에 Commit시 Vercel이 감지하여
