// 현재 프로젝트 4번 "롯데정밀화학 RPA 구축 프로젝트" 페이지 구성
            ...
            <div className="flex">
                ...
                <div className="p-5 w-3/4">
                    ...
                    <div>
                        ...
                        <p className="text-2xl text-slate-800 ml-6 my-1">- 여러 외부 프로그램의 데이터를 수집하고 전자문서 자동 완성</p>
                        <p className="text-2xl text-slate-800 ml-6 my-1">- 이미지 OCR(광학 문자 인식)을 사용하여 PDF 문서에 있는 텍스트 추출 및 데이터화</p>
                        <p className="text-2xl text-slate-800 ml-6 my-1">- VBScript를 사용하여 보안프로그램으로 인한 예외상황 극복</p>
                    </div>
                    {/* 개발 환경 */}
                    <div>
                        ...
                        <p className="text-xl text-slate-800 ml-6 my-1">- Visual Basic기반의 스크립트 언어 VBScript 사용</p>
                    </div>
                    {/* 프로젝트 설명 */}
                    <div>
                        <p className="text-2xl text-slate-800 my-3">◎ 프로젝트 상세</p>
                        <p className="text-xl text-slate-800 ml-6 my-1 inline">▶ 고객사측은 팩스, 스캔된 이미지들로 이루어진 PDF파일에서 데이터를 추출하여 결과물을 만들기를
                ...
                <div className="p-5 w-1/4">
                    ...
                    <div>
                        <p className="text-base text-slate-800 my-3">RPA 솔루션이 제공하는 OCR 기능을 사용하면 이미지에 있는 텍스트를 자동화 봇이 추출하고 유의미하게 사용할 수
                    ...
                    <div>
                        <p className="text-base text-slate-800 my-3">Visual Basic 문법을 대부분 차용한 VBScript는 시스템을 직접 컨트롤 할 수도 있어서 그 위험성으로 인해
